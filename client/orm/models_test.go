...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/i-open/beego/client/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/i-open/beego/client/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/i-open/beego/client/orm
	...
	go test -v github.com/i-open/beego/client/orm
	...
	go test -v github.com/i-open/beego/pgk/orm
